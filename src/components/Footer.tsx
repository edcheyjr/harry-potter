...
const Footer = (props: Props) => {
  return (
    <div className='border-t border-orange-500/80 bg-bg-dark '>
      <div className='w-full flex flex-wrap gap-4 justify-between items-center container mx-auto max-w-7xl px-2 lg:px-10  pb-10 pt-6 lg:pb-4 lg:pt-4 text-slate-300 font-medium'>

...
const Footer = (props: Props) => {
  return (
    <div className='border-t border-orange-500/80 bg-bg-dark'>
      <div className='w-full flex flex-wrap gap-4 justify-between items-center container mx-auto max-w-7xl px-4 md:px-10 lg:px-4 2xl:px-10  min-[495px]:max-md:px-12 pb-10 pt-6 lg:pb-4 lg:pt-4 text-slate-300 font-medium'>

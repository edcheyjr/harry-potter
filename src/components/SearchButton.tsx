...
const SearchButton = (props: Props) => {
  return (
    <button className='px-1.5 md:px-3.5 py-1 rounded bg-white/[8%] flex space-x-2.5 text-gray-50/80 items-center border border-gray-50/20 hover:bg-white/20 transform transition-all ease-in-out duration-300'>
      <SearchIcon
